...
const About = () => {
  return (
    <div className='w-full flex flex-col'>
      ...
      <div className='w-full h-[650px] border-b-2 border-violet12 flex flex-col md:flex-row overflow-hidden'>
        <div className='w-full min-w-[50%] min-h-[50%] h-full md:border-r-2 border-b-2 md:border-b-0 border-violet12 bg-carlos-photo bg-cover bg-center flex items-end justify-end'>
